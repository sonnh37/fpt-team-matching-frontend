        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" className="border-none hover:bg-none">
              Phù hợp nhất <FontAwesomeIcon icon={faAngleDown} />
            </Button>
          </PopoverTrigger>
        ...
        <div className="flex w-full justify-center items-center mr-2">
          ...
          <div className="pl-2 relative w-full">
            ...
            <button
              ...
              className="absolute bottom-4 right-2 bg-blue-500 text-white px-3 py-3 text-sm rounded-md hover:bg-blue-600"
            >
