...
import {
    MentorIdeaRequestGetAllQuery
} from "@/types/models/queries/mentor-idea-requests/mentor-idea-request-get-all-query";
...
export default function InvitationSentForIdeaTable() {
    ...
    const {data, isFetching, error, refetch} = useQuery({
        ...
        queryFn: () => mentoridearequestService.getUserMentorIdeaRequests(queryParams),
