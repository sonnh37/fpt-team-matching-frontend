...
const ExistingProjectAddStudentCard = ({setStudents, projects, project, setProject, updatedTeamMembers}: {
    projects: Project[],
    ...
    return (
        <Card className="w-[30vw]">
            <CardHeader>
                ...
                <CardDescription>Thêm sinh viên vào nhóm đã tồn tại tại đây</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="pb-4">
