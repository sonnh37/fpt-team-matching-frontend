...
const notifications = [
    ...
    { id: 7, avatar: "https://via.placeholder.com/50", name: "Nguyễn C", action: "đã thích bài viết của bạn", time: "1 tháng trước", type: "like" },
];
const Notification = () => {

    const [showAll, setShowAll] = useState(false);

    // Chỉ hiển thị tối đa 6 thông báo nếu showAll = false
    ...
    const tabs = [
        {
            ...
            content: (
                ...
                {/* Danh sách thông báo */}
                <div className={`space-y-4 ${showAll ? "max-h-none" : "max-h-96 overflow-y-auto"}`}>
    ...
    return (
        <div className="bg-slate-200">
            <div className="h-[20rem] md:h-[40rem] [perspective:1000px] relative b flex flex-col max-w-5xl mx-auto w-full  items-start justify-start pt-4 ">
                <Tabs tabs={tabs} />
            </div>
        </div>
    );
