  ...
  return (
    <SidebarProvider className="h-screen overflow-hidden">
      ...
      <SidebarInset className="overflow-hidden">
        <header className="flex h-16 z-10 shrink-0 items-center justify-between gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
