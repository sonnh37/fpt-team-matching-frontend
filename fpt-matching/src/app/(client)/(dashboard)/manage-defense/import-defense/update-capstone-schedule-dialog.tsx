...
export function UpdateCapstoneScheduleDialog(
    ...
    return (
        <AlertDialog open={isOpen}>
            <AlertDialogTrigger asChild>
                <Button className={"mb-8 w-[20vw]"} onClick={() => {setIsOpen(true)}} variant="destructive">Cập nhật lịch bảo vệ đồ án</Button>
            </AlertDialogTrigger>
            <AlertDialogContent  className="sm:max-w-[425px]">
                <AlertDialogHeader>
                    <AlertDialogTitle>Cập nhật lịch bảo vệ đồ án</AlertDialogTitle>
