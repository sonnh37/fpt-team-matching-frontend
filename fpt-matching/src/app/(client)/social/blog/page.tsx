                                            ...
                                            <div className='body px-4 mt-3 h-3/4 flex flex-col gap-4 '>
                                                <div className='flex gap-2 items-center'>
                                                    <div className='items-center'>
                                                        <h3 className={"text-nowrap min-w-24"}><FontAwesomeIcon
                                                            icon={faPencil} className={"pr-1.5"}/> Tiêu đề: </h3>
                                                    </div>
                                                    <Input type="text" value={formData.title} onChange={handleChange}
                                                           placeholder="Nhập tựa đề ở đây" className={"w-[70%]"}/>
                                                </div>
                                                <div className='flex gap-2 items-center'>
                                                    <div className='items-center flex gap-2'>
                                                        <h3 className={"text-nowrap min-w-24 "}><FontAwesomeIcon
                                                            icon={faNoteSticky} className={"pr-1.5"}/> Nội dung: </h3>
                                                    </div>
                                                    <Textarea placeholder="Viết nội dung ở đây." className={"w-[70%]"}
                                                ...
                                                {postType === BlogType.Recruit && user?.projects ? (
                                                    <div className=''>
                                                        <div className='skill'>
                                                            ...
                                                            <div className='flex gap-2 items-center'>
                                                                <div className='items-center flex gap-2'>
                                                                    <h3 className={"text-nowrap min-w-24 "}>Kỹ năng yêu
                                                                        cầu: </h3>
                                                                </div>
                                                                <Textarea placeholder="Viết nội dung ở đây."
                                                                          className={"w-[65%]"}
                                                                          value={formData.skillRequired}
                                                                          onChange={handleChange}/>
                                                            </div>
                                                                    ...
                                                                    <Select value={projectUser?.id}
                                                                        ...
                                                                        <SelectContent>
                                                                            <SelectGroup>
                                                                                ...
                                                                                {projectUser?.id && (
                                                                                    <SelectItem
                                                                                        value={projectUser.id}>{projectUser.teamName}</SelectItem>
                                                                                )}
                                                                            </SelectGroup>
                                                                        </SelectContent>
                                                                    </Select>
                ...
                <DirectionAwareHover imageUrl={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmZDDiSOnUm5PwmDRXejARSnlrrsvu6e9Qhw&s"} children={undefined}>
                  ...
                  <p className="font-normal text-sm">$1299 / night</p>
                    ...
                    <div className='box-info'>
                        <div className=" w-full relative max-w-xs mx-3 m-3">
                            <div
                                className="absolute inset-0 h-full w-full bg-gradient-to-r transform scale-[0.80] rounded-md blur-3xl"/>
                            <div
                                className="relative shadow-xl bg-white border border-gray-200   py-4 h-full overflow-hidden rounded-md flex flex-col justify-end items-start">
                                <div className='w-full border-b-2 border-gray-200   '>
                                    <div className=' mx-3'>
