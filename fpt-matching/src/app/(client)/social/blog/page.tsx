...
export default function Blog() {
  ...
  const [studentProfile, setStudentProfile] = useState<ProfileStudent | null>(
    null
  );
  ...
  useEffect(() => {
    if (studentProfile?.experienceProject) {
      const fetchBlogSuggestion = async () => {
        const response = await apiHubsService.getRecommendBlogs(
          studentProfile.experienceProject!
        );
        if (response) {
          ...
          <aside className="hidden w-64 md:block min-h-screen">
            ...
            <nav className="text-[16px] ">
              <ul className="flex flex-col">
                ...
                <li className="px-4 py-2 text-[12px] uppercase tracking-wider text-gray-500 font-bold">
                  USER MANAGEMENT
                </li>
                <li className="px-4 cursor-pointer hover:bg-blue-300">
                  <a
                    className="py-3 flex items-center"
                    href="/social/blog/blogmanagement"
                  >
                    👥 Users
                  </a>
                </li>
                ...
                <li className="px-4 py-2 mt-2 text-[12px] uppercase tracking-wider text-gray-500 font-bold">
                  Apps
                </li>
                <li className="px-4 cursor-pointer hover:bg-blue-300">
                  <a href="#" className="py-2 flex items-center">
                    ✉️ Messages
                    <span className="ml-auto text-xs bg-gray-300 px-2 py-1 rounded-sm">
                      16
                    </span>
                  </a>
                </li>
            ...
            <Modal>
              <ModalTrigger className="w-full">
                <div className="flex items-center ">
                  ...
                  />
                  <div className="shadow appearance-none bg-slate-200 border rounded-xl w-full py-2 px-3 ml-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-start ">
                      ...
                      <div className="w-full ml-3">
                        <div className=" ">
                          <p className="text-lg font-semibold text-gray-800">
                            <FontAwesomeIcon icon={faUser} /> {user?.lastName}{" "}
                            {user?.firstName}
                          </p>
                        </div>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectGroup>
                              ...
                              <SelectItem value={BlogType.Share.toString()}>
                                Đăng chia sẻ
                              </SelectItem>
                              <SelectItem value={BlogType.Recruit.toString()}>
                                Đăng tìm thành viên
                              </SelectItem>
                            </SelectGroup>
                          </SelectContent>
                        ...
                        <div>
                          ...
                          <div className="flex items-start gap-4 mt-4 min-h-28">
                            ...
                            <div className="w-3/5">
                              ...
                              >
                                ...
                                <SelectContent>
                                  <SelectGroup>
                                    ...
                                    {projectUser?.id && (
                                      <SelectItem value={projectUser.id}>
                              ...
                              {!projectUser?.id && (
                                <h4 className="text-red-400 text-sm mt-2">
                                  *Không có nhóm
                                </h4>
                              )}
                              <h4 className="text-red-400 text-sm">
                                *Không bắt buộc
                              </h4>
                              <h4 className="text-red-400 text-sm">
                                {messageUser}
                ...
                <ModalFooter>
                  <div className="flex w-full h-14 sticky bottom-0  items-center justify-center">
                    <button
                      ...
                      className="bg-blue-500 h-3/4 w-1/3 mx-2 rounded-xl hover:bg-blue-400 hover:text-black  mt-2 mb-4"
                    >
                      Post Bài
                    </button>
                  </div>
          ...
          {isLoading ? (
            ...
            <>
              {result?.data?.results?.map((post) => (
                ...
                <div
                  key={post.id}
                  className="bg-white max-w-3xl mx-3 my-5 p-6 pb-3 rounded-xl shadow-md min-w-[650px] "
                >
                  <div>
                          ...
                          <div className="hover:text-orange-300 text-left">
                            <div className="text-left ">
                              ...
                              {post?.type === BlogType.Recruit && (
                                <div>[🔎Đăng tuyển,tìm thành viên]</div>
                              )}
                            </div>
                            <span
                              className={` ${
                                post?.type === BlogType.Recruit
                                  ? "text-none font-medium text-lg"
                                  : ""
                              }`}
                            >
                              {post.title}
                        ...
                        <ModalBody>
                          <ModalContent className="w-full max-h-[80vh] overflow-y-auto ">
                            ...
                            <div className="header-post w-full h-auto border-gray-500 p-4 border-b-2 bg-white dark:bg-black sticky top-0 z-10">
                              ...
                              <ModalClose className="absolute top-2 right-2">
                                X
                              </ModalClose>
                            </div>
                            ...
                            <div className="flex w-full text-gray-600 border-y-2 p-3">
                              <div className="flex w-full text-base justify-between  items-center space-x-4">
                                <span className="flex items-center">
                                  ...
                                  <span className="ml-2">
                                    {" "}
                                    <FontAwesomeIcon icon={faThumbsUp} /> Lượt
                                    thích{" "}
                                  </span>
                                </span>
                                <span className="flex items-center">
                                  ...
                                  <span className="ml-2">
                                    {" "}
                                    <FontAwesomeIcon icon={faComment} /> Bình
                                    luận
                                  </span>
                                </span>
                                <span className="flex items-center">
                                  ...
                                  <span className="ml-2">
                                    {" "}
                                    <FontAwesomeIcon icon={faPaperclip} /> Nộp
                                    CV
                                  </span>
                                </span>
                              </div>
      ...
      <div className="blog-right basis-1/5 mr-6 min-w-[180px]">
        ...
        <div className="box-title">
          <div className=" w-full relative max-w-xs mx-3 m-3">
            <div className="relative shadow-xl bg-white border border-gray-200   py-4 h-full overflow-hidden rounded-md flex flex-col justify-end items-start">
                  ...
                  >
                    <div className="recommend flex">
                      <h2 className="font-bold  text-gray-700 mb-2 ">
                        <Modal>
                          <ModalTrigger>
                            <div className="w-full text-left">{blog.job}</div>
                            <span className="font-normal mt-1">
                              Tỉ lệ tương đồng:{" "}
                              {typeof blog?.similarity === "number"
                                ? (blog.similarity * 100).toFixed(2)
                                : "N/A"}
                              %
                            </span>
                          </ModalTrigger>
              ...
              <div className=" px-4 py-1 rounded-lg ">Explore</div>
              ...
              {sortFpt.slice(0, 4).map((blogfpt, index) => (
                <div className="w-full h-auto border-b-2 border-gray-200 px-5 py-2">
                  <div className="">
                            ...
                            <div className="body-blogdetail">
                              <div className="flex items-center space-x-4 p-2">
                                ...
                                <div className="flex w-full justify-between">
                                  <div>
                                    <p className="text-lg font-semibold text-gray-800">
                                      {blogfpt?.user?.lastName}{" "}
                                      {blogfpt?.user?.firstName}
                                    </p>
                                    <p className="text-sm text-gray-500">
                                      {blogfpt?.createdDate
                                        ? new Date(
                                ...
                                <div className="flex text-xl text-gray-600 justify-between items-center w-full px-2">
                                  ...
                                  <div className="flex">
                                    <span className="flex items-center">
                                      <i className="fas fa-comment text-green-500"></i>
                                      <span className="ml-2">
                                        {blogfpt?.comments.length ?? 0} bình
                                        luận{" "}
                                      </span>
                                    </span>
                                    <span className="flex items-center mr-3">
                                      <i className="fas fa-image text-red-500"></i>
                                      <span className="ml-2">
                                        {blogfpt?.blogCvs.length ?? 0} nộp CV{" "}
                                      </span>
                                    </span>
                                  </div>
                                </div>
                    ...
                    <p className="text-xm pl-2 text-gray-500">
                      {" "}
                      {blogfpt.comments.length ?? 0} Comment
                    </p>
                  </div>
                </div>
              ))}
        ...
        <div className="w-full box-trending mt-2 ml-4 bg-white border-gray-200 rounded-lg  shadow-xl">
          <div className="w-full h-auto  px-3 py-3">
            <div className="text-black  text-lg font-semibold pl-11 border-b-2 pb-2 border-gray-200 ">
              🔥🔥 Trending 🔥🔥
            </div>
                          ...
                          <div className="body-blogdetail">
                            <div className="flex items-center space-x-4 p-2">
                              ...
                              <div className="flex w-full justify-between">
                                <div>
                                  <p className="text-lg font-semibold text-gray-800">
                                    {postNt?.user?.lastName}{" "}
                                    {postNt?.user?.firstName}
                                  </p>
                                  <p className="text-sm text-gray-500">
                                    {postNt?.createdDate
                                      ? new Date(
                              ...
                              <div className="flex text-xl text-gray-600 justify-between items-center w-full px-2">
                                ...
                                <div className="flex">
                                  <span className="flex items-center">
                                    <i className="fas fa-comment text-green-500"></i>
                                    <span className="ml-2">
                                      {postNt?.comments.length ?? 0} bình luận{" "}
                                    </span>
                                  </span>
                                  <span className="flex items-center mr-3">
                                    <i className="fas fa-image text-red-500"></i>
                                    <span className="ml-2">
                                      {postNt?.blogCvs.length ?? 0} nộp CV{" "}
                                    </span>
                                  </span>
                                </div>
                              </div>
                          ...
                          <div className="flex w-full text-gray-600 border-y-2 p-3">
                            <div className="flex w-full text-base justify-between  items-center space-x-4">
                              ...
                              <span className="flex items-center">
                                ...
                                <span className="ml-2">
                                  {" "}
                                  <FontAwesomeIcon icon={faPaperclip} /> Nộp CV
                                </span>
                              </span>
                            </div>
                          </div>
