...
export default function Blog() {
  ...
  return (
    <div className="bg-slate-200">
      <div className="blog-center container mx-auto bg-slate-200 ">
        <div className="grid grid-cols-12 gap-4 pt-3">
          {/* blog left */}
          <div className="col-span-2">
            <aside className="hidden w-full md:block min-h-screen">
              <div className="py-3 text-2xl items-start bg-white border-b-2 mb-6 px-3">
                <div className="font-bold text-xl">
                  DEV Community is a community of 2,827,832 amazing developers
                </div>
          ...
          <div className="col-span-7">
            <div className="form-create-blog bg-slate-100 rounded-xl w-full p-3">
            ...
            <div className="header-button flex justify-start pt-3">
              <span className="font-extrabold mx-1 px-2  hover:bg-white hover:text-blue-900">
                Relevant
              </span>
              <span className=" px-2  hover:bg-white hover:text-blue-900">
                Latest
              </span>
              <span className="px-2  hover:bg-white hover:text-blue-900">
                Top
            ...
            {/* Blog */}
            <div className="bg-white mx-3 my-8 p-6 rounded-xl shadow-md  ">
              <div>
                  ...
                  <div className="flex w-full justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        4 giờ trước <FontAwesomeIcon icon={faEarthAmericas} />{" "}
                      </p>
                    </div>
                    <div>
                      <DropdownMenu>
                  ...
                  <Modal>
                    <ModalTrigger className="p-0">
                      <TypographyH3 className="text-start">
                        Một trong những dòng Sport Bike hot hit nhà Ducati, thì
                        phải nhắc đến Panigale 899.
                      </TypographyH3>
                    </ModalTrigger>
                    <ModalBody>
                      <ModalContent className="w-full max-h-[80vh] overflow-y-auto ">
                        ...
                        <div className="body-blogdetail">
                          ...
                          {/* Post Content */}
                          <h1 className=" px-2 ">
                            Một trong những dòng Sport Bike hot hit nhà Ducati,
                            thì phải nhắc đến Panigale 899.
                          </h1>
                          <p className="mt-4 text-gray-700 text-xl px-2 ">
                            Với dáng vẻ đầy uy lực cá tính, cùng với khối động
                            cơ L-twin 898cc Superquadro sản xuất công suất 148
                            mã lực và mô-men xoắn 99 Nm – Panigale 899 mau chóng
                            nhận được rất nhiều sự yêu thích của các Biker.
                          </p>
                        ...
                        <div className="flex w-full text-gray-600 border-y-2 p-3">
                          <div className="flex w-full text-xl justify-between  items-center space-x-4">
                            <span className="flex items-center">
                              ...
                              <span className="ml-2">
                                {" "}
                                <FontAwesomeIcon icon={faThumbsUp} /> Lượt thích{" "}
                              </span>
                            </span>
                            <span className="flex items-center">
                              <i className="fas fa-comment text-green-500"></i>
                                ...
                                <div className="grid gap-4">
                                  <div className="space-y-2 hover:bg-slate-300">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                      Hiển thị bình luận được tương tác nhiều
                                      nhất
                                    </p>
                                  </div>
                                  <div className="space-y-2  hover:bg-slate-300">
                ...
                <div className="flex justify-between mt-1 text-gray-600">
                  <div className="flex  items-center space-x-4">
                    <span className="flex items-center">
                      <i className="fas fa-thumbs-up text-blue-500"></i>
                      <span className="ml-2">
                        28 Likes <FontAwesomeIcon icon={faThumbsUp} />{" "}
                      </span>
                    </span>
                    <span className="flex items-center">
                      <i className="fas fa-comment text-green-500"></i>
                      <span className="ml-2">
                        10 Comments <FontAwesomeIcon icon={faComment} />
                      </span>
                    </span>
                    <span className="flex items-center">
                      <i className="fas fa-image text-red-500"></i>
                      <span className="ml-2">
                        +16 Uploads <FontAwesomeIcon icon={faPaperclip} />
                      </span>
                    </span>
                  </div>
                </div>
          ...
          <div className="col-span-3">
            <Card>
              <CardHeader>
                <CardTitle>
                  <TypographyH4 className="text-zinc-700">
                    #discuss
                  </TypographyH4>
                </CardTitle>
                <CardDescription>
                ...
                <div className="space-y-4">
                  <div>
                    <TypographyP className="text-zinc-700">
                      Ok, I think I need to improve my website but not sure how?
                      I don't care how brutal people are, if...
                    </TypographyP>
